from src.app.common.check_address_type import is_account_address
from src.app.contract.get_token_detail import get_token_details
from src.app.settings.si import MAX_NONCE_PLATFORM_WALLET
from src.app.transaction.internal_txs import get_internal_txs_by_hash
from src.app.utils.format_token_amount import get_eth_scaled_value, format_token_amount
